...
public class SysRoleController {
    ...
    @PostMapping("save")
    @ApiOperation("保存")
    public Result save(@RequestBody SysRoleDTO dto, HttpServletRequest request){
        try {
    ...
    @PostMapping("update")
    @ApiOperation("修改")
    public Result update(@RequestBody SysRoleDTO dto, HttpServletRequest request){
        try {
            SysUserEntity user = SpringSecurityUtils.getUserInfo().getUserEntity();
